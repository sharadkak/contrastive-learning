...
class Trainer(object):
    ...
    def train_epoch(self):
        ...
        for iteration, mini_batch in self.state['train_iter']:
            ...
            for sample in mini_batch:
                ...
                # get tensor1 and tensor2 (two views)
                batch_1 = sample['image']
                batch_2 = sample['target_image']

                # once every epoch save images
                if (self.state['epoch']%10 == 0) and (iteration % rand == 0) :
                    save_image(batch_1[0], pt.join(ROOT, '../res/images/'), 'view_one_%d.png' % rand)
                    save_image(batch_2[0], pt.join(ROOT, '../res/images/'), 'view_two_%d.png' % rand)
    ...
    def validate_epoch(self, epoch):
        ...
        # here apply reduce operation to sync batch norm buffers in case of multi gpu training
