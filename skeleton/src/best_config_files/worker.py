...
import cv2
import random
from yiq import transform_hsv, transform_hsv_cv2
...
class ImageWorker(BufferWorker):
    ...
    def prepare_image(self, im, buffers, params, key):
        ...
        # apply augmentations, color inversion and flip channels to image
        ...
        if random.random() > 0.7:
            # apply hsv 
            h, s, v = random.uniform(-0.4, 0.4), random.uniform(0, 1.8), random.uniform(0, 1.8)
