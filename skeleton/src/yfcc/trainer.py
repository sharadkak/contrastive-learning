...
class Trainer(object):
    ...
    def train(self, num_epochs, start_epoch=0):
        ...
        try:
            ...
            path = pt.join(ROOT, '../../res/plots/yfcc/')
    ...
    def train_epoch(self):
        ...
        for iteration, mini_batch in self.state['train_iter']:
            ...
            for sample in mini_batch:
                ...
                if (self.state['epoch']%20 == 0) and (iteration % rand == 0) :
                    save_image(batch_1[0], pt.join(ROOT, '../../res/images/yfcc/'), 'view_one_%d.png' % rand)
                    save_image(batch_2[0], pt.join(ROOT, '../../res/images/yfcc/'), 'view_two_%d.png' % rand)
